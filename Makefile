...
help:
	...
	@echo "  $(YELLOW)make lint$(RESET)             - Run fmt + clippy (default + all features)"
	...
	@echo "  $(YELLOW)make docs$(RESET)             - Build rustdoc (warnings as errors)"
	...
	@echo "  $(YELLOW)make deps$(RESET)             - Update dependencies"
	@echo ""
	...
	@echo "  $(YELLOW)make publish$(RESET)          - Publish all crates to crates.io"
	@echo "  $(YELLOW)make publish-dry-run$(RESET)  - Verify crates are ready to publish"
	@echo "  $(YELLOW)make publish-one CRATE=name$(RESET) - Publish a single crate"
	@echo ""
